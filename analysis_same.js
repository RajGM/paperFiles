...
function main() {
  const directoryPath = './same_agent/json/'; // Directory with all input JSON files
  const outputFilePath = './same_agent/analysis/allfilesWithinRange.json'; // Path for output file
  ...
  const outputVarianceFilePath = './same_agent/analysis/allSameNewsAcrossRange.json';
